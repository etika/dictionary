...
Dictionary is a ruby app which is given a 10 digit phone number, it returns all possible words or combination of words from the provided dictionary, that can be mapped back as a whole to the number.
